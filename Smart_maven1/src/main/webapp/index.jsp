				...
				<div class="grid_4">
					<div class="banner">
						<div class="maxheight">
							...
							Our repository Is safe,where we use DNA Encryption Technology.
                                                        Our repository can be accessed very fast. 
					...
					<div class="banner">
						<div class="maxheight">
							<div class="banner_title">
								...
								<div class="extra_wrapper">Circles&amp;
									<div class="color1">Rights</div>
								</div>
							</div>
							We can share data through circles formed based on the Profession<br/><br /><br />
					...
					<div class="banner">
						<div class="maxheight">
							<div class="banner_title">
								...
								<div class="extra_wrapper">Reliable&amp;
									<div class="color1">Handy</div>
								</div>
							</div>
							System is reliable,user friendly and useful!!<br/><br /><br /><br/>
			...
			<div class="c_phone">
				<div class="container_12">
					<div class="grid_12">
						...
						<span>Get Start With Smart</span>
					</div>
					<div class="clear"></div>
				</div>
			</div>
