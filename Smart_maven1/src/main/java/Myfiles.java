...
@WebServlet(urlPatterns = {"/Myfiles"})
            ...
            throws ServletException, IOException
    {
		...
		id=(String)session.getAttribute("name");
           ...
           /* MongoClient mongo = new MongoClient("localhost", 27017);
            ...
            DBCursor doc = coll.find(new BasicDBObject("email_id", id));
...
"                                   \n" +
"                              <center>  <input type=\"text\" align=\"left\" id=\"text1\" name=\"download\" size=\"50\"> \n" +
"                                \n" +
"                                <input type=\"submit\" class=\"styled-button-8\" value=\"Download\"><br />\n" +
"                            </form><br><br>\n" +
...
"								<div class=\"extra_wrapper\">My Files&nbsp &nbsp &nbsp &nbsp\n" +
"								</div>\n" +
"							</div>\n" +
"");
        ...
        Date d = ((BasicDBObject)obj).getDate("uploadDate");
                out.println("File Name : "+fname+"<br />");
              out.println("Uploaded At : "+d+"<br/> <br/>");
