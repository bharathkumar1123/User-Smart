					...
					<div class="banner">
						<div class="maxheight">
							<div class="banner_title">
								<div class="extra_wrapper">Search Files
								</div>
							</div>
						      <center> 
                                 <form name="myForm"  method="get" action="Myfiles">
                                <input type="submit" class="styled-button-8" value="Show my Files"> 
                            </form><br><br>
                                  <form name="myForm2" method="get" action="My_Group">
                                      <input type="submit" class="styled-button-8" value="Show my group"> </form>
                                 <br><br>
